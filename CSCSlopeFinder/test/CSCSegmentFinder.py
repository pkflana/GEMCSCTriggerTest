...
process.source.fileNames.append("file:2023D_Muon0_RAWRECO_ZmuPromptReco_369943.root")
...
process.CSCSegmentFinder = cms.EDAnalyzer('CSCSegmentFinder', 
...
process.p = cms.Path(process.CSCSegmentFinder)
